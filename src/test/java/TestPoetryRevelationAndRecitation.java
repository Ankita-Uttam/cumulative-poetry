...
//        String[] story = null;
//        try {
//            story = DefaultStory.getStory(Constants.RESOURCE_PATH + Constants.FILE_NAME);
...
//        String[] story = null;
//        try {
//            story = new RandomStory().getStory(Constants.RESOURCE_PATH + Constants.FILE_NAME, seed);
//        } catch (FileNotFoundException ex) {
//            System.out.println(ex.getMessage());
//        }
//        return story;
